...
HUMAN_DIR="${PROJECT_DIR}/Trying3/CoreData/Entities"
MACHINE_DIR="${PROJECT_DIR}/Trying3/CoreData/EntitiesMachine"
INCLUDE_H="${PROJECT_DIR}/Trying3/CoreData/ModelIncludes.h"
